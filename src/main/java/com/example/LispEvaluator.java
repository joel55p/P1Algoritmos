 ...
 * Fecha: 21/03/2025
 * Descripción: Evaluador de expresiones para el intérprete Lisp.
 * Se encarga de evaluar las expresiones parseadas según la semántica de Lisp,
 * incluyendo operaciones aritméticas, variables, funciones y estructuras de control.
 */
package com.example;
...
public class LispEvaluator {
    ...
    /**
     * Evalúa una expresión Lisp y retorna su resultado.
     * 
     * @param expr La expresión a evaluar
     * @return El resultado de la evaluación
     * @throws RuntimeException Si hay errores durante la evaluación
     */
    ...
    /**
     * Obtiene el mapa de funciones definidas por el usuario.
     * 
     * @return Un mapa que relaciona nombres de funciones con sus definiciones
     */
